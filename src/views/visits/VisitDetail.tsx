...
import { PageHead, Btn, Stat, Badge, LinkBtn, Drawer, SignalMix, Dot, DataTable, Card, Eyebrow, type Column } from '@/components';
...
export function VisitDetail() {
  ...
  return (
    <div>
      ...
      <DataTable columns={cols} rows={observations} rowKey="id" onRow={(r) => openObs(r.id)} empty="No observations logged yet for this visit." />
