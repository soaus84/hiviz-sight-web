...
import { PageHead, Btn, LinkBtn, Stat, Card, Eyebrow, Badge, DataTable, Icon, InfoTip, type Column } from '@/components';
    ...
    <div>
      ...
      {risk.severity && (
        <Card pad={20} style={{ marginBottom: 16 }}>
          <Eyebrow right={<InfoTip><RiskRatingInfo /></InfoTip>}>Risk rating</Eyebrow>
      ...
      {sitesDoingWork.length > 0 && (
        <Card pad={20} style={{ marginBottom: 16 }}>
          <Eyebrow>Sites doing this work</Eyebrow>
      ...
      <Eyebrow>Hazards · {hazards.length}</Eyebrow>
      {hazards.length === 0 ? (
