...
export const NOTIFS: { today: Notification[]; earlier: Notification[] } = {
  today: [
    ...
    { id: 'n3', tone: colors.ink, icon: 'calendar_today', unread: true, subject: 'Ridgeback Processing', verb: 'visit starts in 2 hours', detail: 'Thu 8 · 09:30 — briefing ready.', when: '2h', to: 'visits' },
  ],
  earlier: [
