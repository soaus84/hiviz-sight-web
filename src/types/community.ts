export type CommunityKind = 'Org' | 'HighRiskWork' | 'SafetyPractice';
...
export interface Community {
   ...
   * not joined. Undefined for HighRiskWork/SafetyPractice, which stay
   * opt-in. */
  orgLevel?: OrgLevel;
  division?: string;
  subdivision?: string;
   ...
   * Org, which isn't taxonomy-derived. */
  taxonomyId?: string;
}
