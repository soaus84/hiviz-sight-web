...
export function AINote({ title = 'Hiviz', children, style }: AINoteProps) {
  return (
    <div style={{ background: '#FFFEF0', border: `1px solid ${colors.hi}`, borderRadius: 'var(--radius-lg)', padding: '13px 15px', ...style }}>
      ...
      <div style={{ fontFamily: 'var(--font-sans)', fontSize: 13.5, lineHeight: 1.55, color: colors.ink, fontWeight: 500 }}>{children}</div>
    </div>
  );
}
